...
if(isset($_POST['nom']) && isset($_POST['password'])){
    if((!empty($_POST['nom'])) &&(!empty($_POST['password']))){
        ...
        $sql="SELECT * FROM etudient WHERE nom='$nom' AND password='$password'";
...
?>
    ...
    <div class="row gx-lg-5 align-items-center">
        ...
        <h1 class="my-5 display-3 fw-bold ls-tight " style="letter-spacing:2px"> 
            EDUCATION   <br />
            <span class=" text-primary sous" style="font-size:25px">Connexion etudiant</span> </h1>
        ...
        <a href="inscrireetudiant.php" style="margin-left:100px;" >vous n'avez pas un compte? inscrire</a> 
     <br> 
     <br>   
     </div>
</div></div>
